...
<link rel="stylesheet" href="{{ asset('styles/contact&transactionStyle.css') }}">
    ...
    <div class="contact-area pb-4">
        ...
        <div class="company-sosmed">
            ...
            <h5 class="contact-link"><a
                    href="https://www.instagram.com/petzone.indonesia/?igshid=YmMyMTA2M2Y%3D">@petzone.indonesia</a>
            </h5>
        </div>
        <div class="company-sosmed">
            <i class="fa-brands fa-whatsapp"></i>
            <h5 class="contact-link"><a href="https://api.whatsapp.com/send?phone=082271486565">082271486565</a></h5>
        </div>
    </div>
    ...
    <div class="admin-contact-area">
        <div class="box-contact">
            ...
            <div class="list">
                <div class="imgBx">
                    <img src="{{ asset('images/assets/logojpg.jpg') }}">
                ...
                <div class="content">
                    ...
                    <div class="contact-p">
                        ...
                        <p>Business Hour : 09.00 - 22.00
                            ...
                            <br>
                            <i class="fa-solid fa-envelope"></i><a href="mailto: mlikorawung@student.ciputra.ac.id">mlikorawung@student.ciputra.ac.id</a>
                        </p>
                    ...
                    <div class="contact-p">
                        ...
                        <p>Business Hour : 09.00 - 22.00
                            ...
                            <i class="fa-brands fa-whatsapp"></i><a
                                href="https://api.whatsapp.com/send?phone=081216501976">081216501976</a>
                            <br>
                            <i class="fa-solid fa-envelope"></i><a href="mailto: tlikorawung@student.ciputra.ac.id">tlikorawung@student.ciputra.ac.id</a>
                        </p>
                ...
                <div class="content">
                    ...
                    <div class="contact-p">
                        ...
                        <p>Business Hour : 09.00 - 22.00
                            ...
                            <br>
                            <i class="fa-solid fa-envelope"></i><a href="mailto: mjiemesha@student.ciputra.ac.id">mjiemesha@student.ciputra.ac.id</a>
                        </p>
